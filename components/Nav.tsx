        ...
        <>
            ...
            >
                ...
                <Link href="/">
                    ...
                    >
                        <svg className="w-7 h-7 text-indigo-500" aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                ...
                <Link href="/about">
                    ...
                    >
                        <svg className="w-7 h-7 text-indigo-500" aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
