    ...
    return (
        <>
            ...
            >
                ...
                <Link href="/sign-in">
                    <a
                        className={`${currentRoute === "/sign-in" ? "text-indigo-500" : "text-gray-300"} "justify-center grid grid-cols-10 gap-1 hover:bg-gray-700/40 hover:text-indigo-500 px-3 py-4 rounded-md text-xl font-medium"`}
                    >
                        <svg className="w-7 h-7" aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
