...
export default function SignIn() {
  return (
    <>
      <Head>
        <title>Sign in to your I Ching account</title>
        ...
        <div className="w-full max-w-md space-y-8">
          <div>
            ...
            <div className="z-30">
                ...
                <h2 className="mt-14 pb-8 text-center text-3xl font-bold tracking-tight text-gray-300 z-30">
          ...
          <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-indigo-500 hover:text-gray-300">
